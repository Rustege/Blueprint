 ...
 * @since 1.6
 */
public class SfdcommbAccessProfilesContextProvider extends AbstractBlueprintContextProvider
{
    @Override
    protected BlueprintContext updateBlueprintContext(BlueprintContext context)
    {
		...
		context.setTitle("SFDCOMMB-396 Document Elevated Access Profiles");
        return context;
